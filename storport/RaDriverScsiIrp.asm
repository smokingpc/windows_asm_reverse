...
fffff80d`808071b3 c6878d000000a8  mov     byte ptr [rdi+8Dh],0A8h       ;update Irp->Tail.Overlay.DriverContext
fffff80d`808071ba 488b4e40        mov     rcx,qword ptr [rsi+40h]       ;DeviceExtension of miniport DEVICE OBJECT => AdapterExt
